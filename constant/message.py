class ReadyMessage:
    ...
    category_added_successfully = "دسته مورد نظر با *موفقیت* اضافه گردید."
    request_content_text = "نام کانال: {}\n" \
                           "آیدی کانال: {}\n" \
                           "توضیحات کانال: {}\n" \
                           "دسته کانال: {}\n"
    accept_content = "کانال پذیرفته شد."
    accept_content_successfully = "درخواست درج کانال شما برای معرفی در کانال منتخبین پذیرفته شد."
    reject_content = "کانال رد شد."
    ...
    replace_description = "متن جایگزین توضیحات را وارد نمایید."
...
class TMessage:
    ...
    send_content = "ارسال کانال منتخب خود"
